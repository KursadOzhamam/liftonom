...
const PLACEHOLDERS = [
  "firma_adi", "firma_vkn", "firma_adres", "firma_telefon", "musteri_adi", "bina_adi",
  "tutar", "teslim_gun", "garanti_yil", "belge_tarihi", "gecerlilik",
];

export default function AtfTemplateEditorPage() {
  ...
  async function save() {
    ...
    setSaving(true);
    try {
      const body = { name: name.trim(), kind: "atf", type: "Asansör Talep Formu", is_default: isDefault, is_active: isActive, clauses, variables };
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-ink">{isNew ? "Yeni Asansör Talep Formu Şablonu" : "Asansör Talep Formu Şablonu"}</h1>
      ...
      <div className="mt-5 rounded-2xl border border-line bg-card p-6">
        ...
        <div className="mt-4 flex flex-wrap gap-6">
          <label className="flex items-center gap-2 text-sm text-ink-soft">
            ...
            Varsayılan şablon (yeni asansör talep formu kaydında ön-seçili gelir)
          </label>
          <label className="flex items-center gap-2 text-sm text-ink-soft">
